...
public class Account {
    ...
    // TODO: Task3
    // replace the null with a lambda expression
    public static AddMaker maker = x -> (Account a) -> a.balance += x;
    ...
    public static int getMaxAccountID(List<Account> accounts) {
        // TODO: Task4
        // replace the null with a lambda expression
        Account maxOne = accounts.stream().reduce(new Account(0, -100), (max, current) ->
                max.balance < current.balance ? current : max
        );
